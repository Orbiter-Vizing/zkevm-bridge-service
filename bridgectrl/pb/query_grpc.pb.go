...
const (
	...
	BridgeService_PushBridge_FullMethodName      = "/bridge.v1.BridgeService/PushBridge"
)
...
type BridgeServiceClient interface {
	...
	PushBridge(ctx context.Context, in *PushBridgeRequest, opts ...grpc.CallOption) (*PushBridgeResponse, error)
}
...
func (c *bridgeServiceClient) PushBridge(ctx context.Context, in *PushBridgeRequest, opts ...grpc.CallOption) (*PushBridgeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PushBridgeResponse)
	err := c.cc.Invoke(ctx, BridgeService_PushBridge_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BridgeServiceServer interface {
	...
	PushBridge(context.Context, *PushBridgeRequest) (*PushBridgeResponse, error)
...
func (UnimplementedBridgeServiceServer) PushBridge(context.Context, *PushBridgeRequest) (*PushBridgeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushBridge not implemented")
}
...
func _BridgeService_PushBridge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushBridgeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BridgeServiceServer).PushBridge(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BridgeService_PushBridge_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BridgeServiceServer).PushBridge(ctx, req.(*PushBridgeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BridgeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PushBridge",
			Handler:    _BridgeService_PushBridge_Handler,
		},
	},
